...
encryption = Checkbutton(text="Encryption", variable=checkEncryption, borderwidth=2,
...
image_label.bind("<Button-1>", lambda e: webbrowser.open_new_tab("https://theabhishek.me"))
...
detail = Button(text="Help", font=("Arial", 10), command=details, bg='white')
...
def report_issue():
    if messagebox.askyesno(title="Report Error", message="Would you like to report any error ?"):
        webbrowser.open_new_tab(url="https://theabhishek.me")
...
def search_option_enabling():
    ...
    try:
        if len(data['email']) > 0:  # just to force user to create account first
            ...
            image_label_search_win.bind("<Button-1>", lambda e: webbrowser.open_new_tab("https://theabhishek.me"))
            ...
            credit_search = Button(search_win, text="Report Error", font=("consolas", 10), bg='white',
            ...
            credit_search.grid(row=10, column=1)

            def light_mode_search():
                themes.light_mode_func_search(image_label_search_win, search_win, space_label1, label_search,
            ...
            def dark_mode_search():
                themes.dark_mode_func_search(image_label_search_win, search_win, space_label1, label_search,
...
clear = Button(text="❌", font=('Consolas', 10), command=clear_options)
...
create_new_acc = Button(text="Create Account", font=('arial', 9), command=account_func, bg='white', borderwidth=1)
...
credit.config(activebackground='blue', activeforeground='black', borderwidth=1)
credit.grid(row=12, column=1)

image = PhotoImage(file="images/new3.png")
